...
> [CONFIG.md](../../manuals/CONFIG.md), [DPI-AUDIT.md](../../reports/DPI-AUDIT.md) и [CHANGELOG](../../../../CHANGELOG.md).
...
| **DPI 1.x/2.x** | теллы fake-tls (ALPN/ext/nonce/size) | Точно, но **уже** в `docs/*/reports/DPI-AUDIT.md` со статусами; закрывается режимом `reality-tls`. Не ново. |
