...
> Текущее состояние смотрите в [ROADMAP.md](../../plans/ROADMAP.md),
> [TRANSPORT-CORE.md](../../reference/TRANSPORT-CORE.md), [ROAMING.md](../../plans/ROAMING.md) и `CHANGELOG.md`.
...
> остаток DPI-работы ведётся в [DPI-AUDIT.md](../../reports/DPI-AUDIT.md) и
...
(см. [ROADMAP.md](../../plans/ROADMAP.md)).
